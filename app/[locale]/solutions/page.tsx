...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return buildMetadata({
    ...
    description:
      'Google Workspace, Microsoft 365, HubSpot CRM, Apollo, Google Cloud, AI Automation, TeamViewer, and Adobe Business — deployed and supported across Myanmar and Thailand.',
  })
}
